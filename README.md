...
[![Static Badge](https://img.shields.io/badge/discord-3170%20total-brightgreen?logo=discord&logoColor=white)](https://discord.com/invite/wDn7cj68gm)
...
* **GPU Optimized:** Features three specialized scripts
  - **RTX 30XX (CUDA 12.6)**
...
| Feature | RTX 30XX  | RTX 40XX / 50XX  | RTX 50XX (Optimized)  |
| :--- | :--- | :--- | :--- |
| **Python** | 3.10.11  | 3.10.11  | 3.11.9  |
| **PyTorch** | 2.6.0  | 2.7.1  | 2.10.0  |
| **CUDA** | 12.6  | 12.8  | 13.0  |
| **SageAttention** | v2.1.1 | v2.2.0  | v2.2.0  |
| **FlashAttention** | (Standard) | v2.7.4  | v2.8.3  |
| **Triton** | < v3.3 | < v3.4  | Standard  |

## ⚠️ Requirements

* **OS:** Windows 10/11.
* **GPU:** NVIDIA RTX 30XX RTX 40XX or 50XX series (required for these specific hardware-accelerated kernels).
