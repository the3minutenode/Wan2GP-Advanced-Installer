...
Title The 3-Minute Node Wan2GP Advanced Installer v0.2.1 (RTX 30XX Only)
...
echo %CYAN%[+] Installing SageAttention 2.1.1 (CU126) ...%RESET%
...
"%PYTHON_EXE%" -I -m pip install https://github.com/woct0rdho/SageAttention/releases/download/v2.1.1-windows/sageattention-2.1.1+cu126torch2.6.0-cp310-cp310-win_amd64.whl %PIP_OPTS%
...
REM "%PYTHON_EXE%" -I -m pip install https://github.com/Redtash1/Flash_Attention_2_Windows/releases/download/v2.7.0-v2.7.4/flash_attn-2.7.4.post1+cu128torch2.7.0cxx11abiFALSE-cp310-cp310-win_amd64.whl %PIP_OPTS%
...
REM "%PYTHON_EXE%" -I -m pip install https://github.com/deepbeepmeep/kernels/releases/download/GGUF_Kernels/llamacpp_gguf_cuda-1.0.2+torch271cu128py310-cp310-cp310-win_amd64.whl %PIP_OPTS%
...
echo.
echo %CYAN%[+] Setup Complete for RTX 30XX and Wan2GP.%RESET%
pause
exit /b
