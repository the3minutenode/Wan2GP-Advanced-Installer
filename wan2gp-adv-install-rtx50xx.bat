...
Title The 3-Minute Node Wan2GP Advanced Installer v0.2.1 (RTX 50XX Only)
:: Specialized for Python 3.11 / CUDA 13.0 / PyTorch 2.10.0

setlocal enabledelayedexpansion

call :set_colors

:: Configuration for RTX 50XX / Python 3.11
set "PYTHON_URL=https://www.python.org/ftp/python/3.11.9/python-3.11.9-embed-amd64.zip"
set "TRITON_LIBS_URL=https://github.com/woct0rdho/triton-windows/releases/download/v3.0.0-windows.post1/python_3.11.9_include_libs.zip"
set "EMBED_DIR=%~dp0python_embeded"
set "WAN_DIR=%~dp0Wan2GP"
set "PYTHON_EXE=%EMBED_DIR%\python.exe"
set "PIP_INDEX=--index-url https://download.pytorch.org/whl/cu130"
...
echo %CYAN%[+] Downloading Python 3.11 Embeddable...%RESET%
...
echo %CYAN%[+] Downloading 3.11 headers/libs for Triton...%RESET%
...
echo %CYAN%[+] Installing PyTorch 2.10.0 + CUDA 13.0 (50XX Optimized)...%RESET%
"%PYTHON_EXE%" -I -m pip install torch==2.10.0 torchvision torchaudio %PIP_INDEX% %PIP_OPTS%

echo %CYAN%[+] Installing Specialized 50XX Kernels...%RESET%
echo %CYAN%[+] Installing Triton for Windows...%RESET%
"%PYTHON_EXE%" -I -m pip install -U triton-windows %PIP_OPTS%

echo %CYAN%[+] Installing SageAttention 2.2.0 (CU130) + FlashAttention 2.8.3 ...%RESET%
...
"%PYTHON_EXE%" -I -m pip install https://github.com/deepbeepmeep/kernels/releases/download/Flash2/flash_attn-2.8.3-cp311-cp311-win_amd64.whl %PIP_OPTS%
"%PYTHON_EXE%" -I -m pip install https://github.com/deepbeepmeep/kernels/releases/download/GGUF_Kernels/llamacpp_gguf_cuda-1.0.2+torch210cu13py311-cp311-cp311-win_amd64.whl %PIP_OPTS%
...
echo.
echo %CYAN%[+] Setup Complete for RTX 50XX and Wan2GP.%RESET%
pause
exit /b
